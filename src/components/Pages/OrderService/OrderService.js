                        ...
                        <div className="row">
                            <div className="col-sm-12 service-content">
                                ...
                                <div className="liner-container">
                                    <h4 className="service-area-title text-center">Select Your Area</h4>
                                </div>
                    ...
                    <div className="mt-4">
                        <div className="row area-selection-button-area py-4">
                            <div className="col-sm-6">
                                <NavLink to="/dhanmondi"><button className="btn btn-success">Dhanmondi</button></NavLink>                               
                            </div>
                            <div className="col-sm-6">
                                <NavLink to="/mirpur"><button className="btn btn-success">Mirpur</button></NavLink>                            
                            </div>
                        </div>
                    </div>
               </div>
