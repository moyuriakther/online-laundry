                     ...
                     <div className="row">
                         <div className="col-sm-12 service-content">
                             ...
                             <div className="liner-container">
                                 <h4 className="service-area-title text-center">Select A Vendor</h4>
                             </div>
                 ...
                 <div className="mt-4">
                     <div className="row area-selection-button-area py-4">
                         <div className="col-sm-6">
                             <NavLink to="/laundryService"> <button className="btn btn-success">Clean Up BD</button></NavLink>                            
                         </div>
                         <div className="col-sm-6">
                             <NavLink to="/laundryService"><button className="btn btn-success">Laundry Express</button></NavLink>                         
                         </div>
                     </div>
                 </div>
            </div>
