                 ...
                 <div className="mt-4">
                     <div className="row area-selection-button-area py-4">
                         <div className="col-sm-6">
                             <NavLink to="/laundryService"><button className="btn btn-success">Bd Laundry Care</button></NavLink>
                         </div>
                         <div className="col-sm-6">
                             <NavLink to="/laundryService"><button className="btn btn-success">Ali Laundry</button></NavLink>
                         </div>
                     </div>
                 </div>
            </div>
